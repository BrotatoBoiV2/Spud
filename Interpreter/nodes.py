...
class VariableNode(Node):
    ...
    def execute(self, memory):
        ...
        if self.value["action"] == "set":
            ...
            args      = self.value["content"]["args"]
            eval_args = [args.execute(memory) for args in args]
            ...
            result    = node.execute(memory, evaluated_args=eval_args)
